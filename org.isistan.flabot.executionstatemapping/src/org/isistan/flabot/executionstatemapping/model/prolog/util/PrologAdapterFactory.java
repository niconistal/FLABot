...
public class PrologAdapterFactory extends AdapterFactoryImpl {
	...
	protected PrologSwitch<Adapter> modelSwitch =
		new PrologSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTagProvider(TagProvider object) {
				return createTagProviderAdapter();
			}
			@Override
			public Adapter casePrologCodeFactory(PrologCodeFactory object) {
				return createPrologCodeFactoryAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseVisitorExpressionProlog(VisitorExpressionProlog object) {
				return createVisitorExpressionPrologAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.isistan.flabot.executionstatemapping.model.prolog.TagProvider <em>Tag Provider</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTagProviderAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.isistan.flabot.executionstatemapping.model.prolog.PrologCodeFactory <em>Code Factory</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPrologCodeFactoryAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.isistan.flabot.executionstatemapping.model.prolog.VisitorExpressionProlog <em>Visitor Expression Prolog</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVisitorExpressionPrologAdapter() {
		return null;
	}
