 ...
 * $Id$
 */
package org.isistan.flabot.executionstatemapping.model.visual.util;
...
public class VisualAdapterFactory extends AdapterFactoryImpl {
	...
	protected VisualSwitch<Adapter> modelSwitch =
		new VisualSwitch<Adapter>() {
			...
			@Override
			public Adapter caseNamedElementModel(NamedElementModel object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.isistan.flabot.executionstatemapping.model.visual.StateDiagram <em>State Diagram</em>}'.
	 * <!-- begin-user-doc -->
