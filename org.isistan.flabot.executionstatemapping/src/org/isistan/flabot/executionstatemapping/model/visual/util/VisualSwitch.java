...
public class VisualSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VisualPackage.STATE_DIAGRAM: {
				StateDiagram stateDiagram = (StateDiagram)theEObject;
				T result = caseStateDiagram(stateDiagram);
				if (result == null) result = caseDiagram(stateDiagram);
				if (result == null) result = caseNamedElementModel(stateDiagram);
	 ...
	 * @generated
	 */
	public T caseNamedElementModel(NamedElementModel object) {
		return null;
	}
