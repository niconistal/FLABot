 ...
 * </copyright>
 *
 * $Id: ConfigSwitch.java,v 1.7 2006/03/29 21:21:28 dacostae Exp $
 */
...
public class ConfigSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConfigPackage.TRACE_CONFIGURATION: {
				TraceConfiguration traceConfiguration = (TraceConfiguration)theEObject;
				Object result = caseTraceConfiguration(traceConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigPackage.FILTER: {
				...
				if (result == null) result = caseFilter_1(filter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Trace Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Trace Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
