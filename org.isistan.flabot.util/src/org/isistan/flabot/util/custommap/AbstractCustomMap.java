...
public abstract class AbstractCustomMap<K,V> implements Map<K,V> {
     ...
     * implicit.)
     */
    protected AbstractCustomMap(HashProvider<K> hashProvider) {
	...
	if (keySet == null) {
		...
		@Override
		public int size() {
		    return AbstractCustomMap.this.size();
		}

		@Override
		public boolean contains(Object k) {
		    return AbstractCustomMap.this.containsKey(k);
		}
	    };
	}
	return keySet;
	...
	if (values == null) {
		...
		public boolean contains(Object v) {
		    return AbstractCustomMap.this.containsValue(v);
		}
	    };
	}
	return values;
	...
	protected Object clone() throws CloneNotSupportedException {
    	AbstractCustomMap<K,V> result = (AbstractCustomMap<K,V>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
     ...
     */
    int hash(Object x) {
        int h = hashProvider.getHashCode(x);
    ...
    boolean eq(Object x, Object y) {
        ...
        return hashProvider.areEquals(x,y);
    }
}
