 ...
 */
public class WeakCustomMap<K,V>
    extends AbstractCustomMap<K,V>
    implements Map<K,V> {
     ...
     */
    public WeakCustomMap(int initialCapacity, float loadFactor, HashProvider<K> hashProvider) {
    	super(hashProvider);
     ...
     * @throws IllegalArgumentException  If the initial capacity is negative.
     */
    public WeakCustomMap(int initialCapacity, HashProvider<K> hashProvider) {
        this(initialCapacity, DEFAULT_LOAD_FACTOR, hashProvider);
    }
     ...
     */
    public WeakCustomMap(HashProvider<K> hashProvider) {
        super(hashProvider);
     ...
     * @since	1.3
     */
    public WeakCustomMap(Map<? extends K, ? extends V> t, HashProvider<K> hashProvider) {
        this(Math.max((int) (t.size() / DEFAULT_LOAD_FACTOR) + 1, 16),
             DEFAULT_LOAD_FACTOR, hashProvider);
        putAll(t);
    }
    ...
    private static class Entry<K,V> extends WeakReference<K> implements Map.Entry<K,V> {
        ...
        public K getKey() {
            return WeakCustomMap.<K>unmaskNull(get());
        }
	...
	Object currentKey = null;
        ...
        public void remove() {
            ...
            WeakCustomMap.this.remove(currentKey);
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        @Override
		public int size() {
            return WeakCustomMap.this.size();
        }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K,V>> {
		...
		public Object[] toArray() {
            ...
            for (Iterator<Map.Entry<K,V>> i = iterator(); i.hasNext(); )
                c.add(new AbstractCustomMap.SimpleEntry<K,V>(i.next()));
            return c.toArray();
        }
