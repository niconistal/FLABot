/** * $Id: JTypeVariable.java,v 1.2 2006/02/14 04:34:54 dacostae Exp $ * $Author: dacostae $ */package org.isistan.flabot.javamodel;
 ...
 * @since 1.5
 */
public interface JTypeVariable extends
			JObject,
			JType {
    /**
    ...
    */
    JArray<? extends JType> getBounds();
     ...
     * @since 1.5
     */
    JGenericDeclaration getGenericDeclaration();
