 ...
 * </copyright>
 *
 * $Id: JavalogtraceSwitch.java,v 1.9 2006/07/04 12:42:19 mblech Exp $
 */
 ...
 * @generated
 */
public class JavalogtraceSwitch {
	/**
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JavalogtracePackage.JAVALOG_TRACE_INFERENCE_STRATEGY: {
				JavalogTraceInferenceStrategy javalogTraceInferenceStrategy = (JavalogTraceInferenceStrategy)theEObject;
				Object result = caseJavalogTraceInferenceStrategy(javalogTraceInferenceStrategy);
				if (result == null) result = caseTraceInferenceStrategy(javalogTraceInferenceStrategy);
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Javalog Trace Inference Strategy</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Javalog Trace Inference Strategy</em>'.
