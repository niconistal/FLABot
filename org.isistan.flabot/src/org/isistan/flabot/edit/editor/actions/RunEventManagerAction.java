/**
 * $Id: RunEventManagerAction.java,v 1.3 2006/03/21 01:51:55 franco Exp $
 * $Author: franco $
 */
...
public class RunEventManagerAction extends SelectionAction{
	...
	public static final String
		RUN_EVENT_MANAGER = "RUN_EVENT_MANAGER";   //$NON-NLS-1$
	...
	public RunEventManagerAction(IWorkbenchPart part) {
		super(part);
		setText(Messages.getString("org.isistan.flabot.edit.editor.actions.RunEventManagerAction.text")); //$NON-NLS-1$
