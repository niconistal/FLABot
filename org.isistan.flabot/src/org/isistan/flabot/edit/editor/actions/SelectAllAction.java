/**
 * $Id: SelectAllAction.java,v 1.3 2006/03/21 01:51:55 franco Exp $
 * $Author: franco $
 */
...
public class SelectAllAction extends Action {
	...
	public SelectAllAction(IWorkbenchPart part) {
		this.part = part;
		setText(Messages.getString("org.isistan.flabot.edit.editor.actions.SelectAllAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.isistan.flabot.edit.editor.actions.SelectAllAction.toolTipText")); //$NON-NLS-1$
	...
	public void run() {
		...
		if (viewer != null) {
			...
			for(Iterator iter=c.iterator(); iter.hasNext();) {
				...
				if(part != viewer.getRootEditPart() && !viewer.getRootEditPart().getChildren().contains(part))
					selection.add(part);				
			}
