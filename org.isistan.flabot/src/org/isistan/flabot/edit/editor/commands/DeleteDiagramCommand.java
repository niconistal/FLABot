/**
 * $Id: DeleteDiagramCommand.java,v 1.3 2006/03/21 01:51:56 franco Exp $
 * $Author: franco $
 */
...
public class DeleteDiagramCommand extends Command {
	...
	public DeleteDiagramCommand(FlabotFileModel file, Diagram diagram)  {
		...
		setLabel(Messages.getString("org.isistan.flabot.edit.editor.commands.DeleteDiagramCommand.label")); //$NON-NLS-1$
	}
