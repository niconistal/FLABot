/**
 * $Id: AddNoteConnectionPasteCommand.java,v 1.5 2006/03/21 01:51:55 franco Exp $
 * $Author: franco $
 */
...
public class AddNoteConnectionPasteCommand extends AddNoteConnectionCommand implements RetargetConnectionPasteCommand {
	...
	public AddNoteConnectionPasteCommand(ConnectionVisualModel copyConnectionModel) {
		...
		setLabel(Messages.getString("org.isistan.flabot.edit.editor.commands.paste.AddNoteConnectionPasteCommand.label")); //$NON-NLS-1$
	}
