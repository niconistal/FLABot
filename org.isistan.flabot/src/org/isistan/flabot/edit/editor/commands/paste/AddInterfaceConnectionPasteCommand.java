/**
 * $Id: AddInterfaceConnectionPasteCommand.java,v 1.6 2006/03/21 01:51:55 franco Exp $
 * $Author: franco $
 */
...
public class AddInterfaceConnectionPasteCommand extends AddInterfaceConnectionCommand implements RetargetConnectionPasteCommand {
	...
	public AddInterfaceConnectionPasteCommand(ConnectionVisualModel copyConnectionModel) {
		...
		setLabel(Messages.getString("org.isistan.flabot.edit.editor.commands.paste.AddInterfaceConnectionPasteCommand.label")); //$NON-NLS-1$
	}
