/**
 * $Id: NoteEditManager.java,v 1.3 2005/11/15 01:02:57 franco Exp $
 * $Author: franco $
 */
...
public class NoteEditManager extends DirectEditManager
{
	...
	public NoteEditManager(GraphicalEditPart source, CellEditorLocator locator) {	
	...
	protected void initCellEditor() {
		...
		DirectEditableFigure stickyNote = (DirectEditableFigure)getEditPart().getFigure();
