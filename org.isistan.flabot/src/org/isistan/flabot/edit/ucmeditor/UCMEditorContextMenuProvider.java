...
//		}
		...
		SetFaultyPath actionFaulty = (SetFaultyPath)getAction(SetFaultyPath.EDIT_COMPONENT);
		if(actionFaulty.calculateEnabled()){
			MenuManager subMenu= new MenuMAnager(Messages.getString("org.isistan.flabot.edit.ucmeditor.UCMEditorContextMenuProvider.SetFaultyPath"));
