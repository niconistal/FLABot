/**
 * $Id: PathPointFigure.java,v 1.26 2006/03/21 02:34:08 franco Exp $
 * $Author: franco $
 */
...
public class PathPointFigure extends Shape {
	...
	public static final Font defaultFont = new Font(Display.getCurrent(), "Verdana", 8, SWT.NONE); //$NON-NLS-1$
	...
	public void outlineShape(Graphics graphics) {
		if (isStartPoint) {
			...
			Rectangle oval = new Rectangle(getLocation().x + 3,
					getLocation().y + 3, defaultsize.width / 2, defaultsize.height / 2);
