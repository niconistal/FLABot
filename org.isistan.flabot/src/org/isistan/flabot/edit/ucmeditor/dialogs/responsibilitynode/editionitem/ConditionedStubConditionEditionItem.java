...
import org.isistan.flabot.edit.ucmeditor.commands.model.AddAssociatedConditionToConditionEventCommand;
...
import org.isistan.flabot.edit.ucmeditor.commands.model.DeleteAssociatedConditionFromConditionEventCommand;
import org.isistan.flabot.edit.ucmeditor.commands.model.DeleteAssociatedNodeFromFamilyCommand;
import org.isistan.flabot.edit.ucmeditor.commands.model.DeleteConditionFromResponsibilityCommand;
import org.isistan.flabot.edit.ucmeditor.commands.model.ModifyConditionCommand;
import org.isistan.flabot.edit.ucmeditor.dialogs.EditDependencyDialog;
import org.isistan.flabot.edit.ucmeditor.dialogs.EditEventConditionDialog;
...
/**
 * Edit conditioned stub responsibility node conditions
 * 
 * @author $Author: Martin Villalba $
 *
 */
public class ConditionedStubConditionEditionItem extends EditionTabItemImpl<ResponsibilityNode>
		implements ConditionedStubResponsibilityNodeEditionItem {

	private Composite mainGroup;
	private ResponsibilityNode resposibilityNode;
	...
	public void initialize(TabFolder tabFolder, TabItem tabItem,
			ResponsibilityNode element) {

		resposibilityNode = element;
		
		Responsibility responsibility = resposibilityNode.getResponsibility(); 
		CoreModel coreModel = responsibility.getCoreModel();

		//Creates the group for the conditions
		createConditions(tabFolder, tabItem, element, coreModel.getUseCaseMaps(), coreModel.getFamilies(), coreModel.getConditionEvents(), responsibility.getPreconditions(), responsibility.getPostconditions());
	}
	...
	private void createConditions(TabFolder folder, TabItem tabItem, ResponsibilityNode actualNode, List useCaseMaps, List families, List events, List preconditions, List postconditions) {
