 ...
 * <copyright>
 * </copyright>
 * $Id: UcmmodelSwitch.java,v 1.64 2006/04/11 23:31:50 franco Exp $
 */
...
public class UcmmodelSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UcmmodelPackage.UCM_DIAGRAM: {
				...
				if (result == null) result = caseDiagram(ucmDiagram);
				if (result == null) result = caseAdapter(ucmDiagram);
				if (result == null) result = caseNamedElementModel(ucmDiagram);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>UCM Diagram</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>UCM Diagram</em>'.
