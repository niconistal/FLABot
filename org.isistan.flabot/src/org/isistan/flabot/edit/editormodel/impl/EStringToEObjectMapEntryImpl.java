 ...
 * </copyright>
 *
 * $Id: EStringToEObjectMapEntryImpl.java,v 1.1 2006/01/25 21:14:14 mblech Exp $
 */
...
public class EStringToEObjectMapEntryImpl extends EObjectImpl implements BasicEMap.Entry {
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditormodelPackage.ESTRING_TO_EOBJECT_MAP_ENTRY__KEY, oldKey, key));
	}
	...
	public void setTypedValue(EObject newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EditormodelPackage.ESTRING_TO_EOBJECT_MAP_ENTRY__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EditormodelPackage.ESTRING_TO_EOBJECT_MAP_ENTRY__VALUE, null, msgs);
			msgs = basicSetTypedValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditormodelPackage.ESTRING_TO_EOBJECT_MAP_ENTRY__VALUE, newValue, newValue));
	}
