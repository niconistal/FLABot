 ...
 *
 */
public class MainResponsibilityEditionItem extends EditionTabItemImpl<Responsibility> implements
		ResponsibilityEditionItem {
	...
	public void initialize(TabFolder tabFolder, TabItem tabItem,
		...
		name.setText(Messages.getString("org.isistan.flabot.edit.componenteditor.dialogs.EditResponsibilityDialog.responsibilityName")); //$NON-NLS-1$
	    ...
	    description.setText(Messages.getString("org.isistan.flabot.edit.componenteditor.dialogs.EditResponsibilityDialog.description")); //$NON-NLS-1$
	...
	private void updateStatus() {
		...
		if(newName.trim().length()==0) {
    		nameStatus=new SingleEditionItemStatus(
    				...
    				Messages.getString("org.isistan.flabot.edit.componenteditor.dialogs.responsibility.editionitem.MainResponsibilityEditionItem.noNameSet")); //$NON-NLS-1$
    	} else {
    	...
    	if(newDescription.trim().length()==0) {
    		descriptionStatus=new SingleEditionItemStatus(
    				...
    				Messages.getString("org.isistan.flabot.edit.componenteditor.dialogs.responsibility.editionitem.MainResponsibilityEditionItem.noDescriptionSet")); //$NON-NLS-1$
    	} else {
