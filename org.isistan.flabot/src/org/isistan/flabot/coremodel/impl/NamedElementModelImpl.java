 ...
 * </copyright>
 *
 * $Id: NamedElementModelImpl.java,v 1.6 2006/03/11 00:15:36 dacostae Exp $
 */
...
public class NamedElementModelImpl extends EObjectImpl implements NamedElementModel {
	...
	protected EClass eStaticClass() {
		return CoremodelPackage.Literals.NAMED_ELEMENT_MODEL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoremodelPackage.NAMED_ELEMENT_MODEL__NAME, oldName, name));
	}
