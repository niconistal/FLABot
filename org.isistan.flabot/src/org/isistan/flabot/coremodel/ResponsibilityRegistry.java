/**
 * $Id: ResponsibilityRegistry.java,v 1.3 2006/02/01 00:26:58 mblech Exp $
 * $Author: mblech $
 */
...
public interface ResponsibilityRegistry extends EObject {
	 ...
	 */
	Registrable register(Responsibility responsibility, ComponentModel component,
			ComponentRole role, Registrable registrable);
	 ...
	 * @return
	 */
	Registrable get(Responsibility responsibility, ComponentModel component,
			ComponentRole role);
